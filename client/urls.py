...
urlpatterns = [
    ...
    # path('Order-Detail-Success/<int:pk>', views.order_detail_success, name='order_detail_success'),
    # path('Order-Detail-Fail/<int:pk>', views.order_detail_fail, name='order_detail_fail'),

    # path('Delivery-Status/<int:pk>', views.order_status, name='order_status'),
]